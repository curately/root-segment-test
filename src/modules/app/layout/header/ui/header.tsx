...
import { SearchBarDesktop } from '../../searchbar-new/ui/search-bar-desktop'
import { SearchBarMobileContainer } from '../../searchbar-new/ui/searchbar-mobile-container'
import { MenuContainer } from './menu-container'

const MOBILE_BREAKPOINT = 768
const pages = ROUTE_URLS.pages
const propertyValues = Object.values(pages)
const noSearchBarRoutes: Array<string> = [ROUTE_URLS.pages.home]
const searchBarRoutesContained: Array<string> = [ROUTE_URLS.pages.bestOf, ROUTE_URLS.pages.about]
const searchBarRoutesShouldScroll: Array<string> = [
  ROUTE_URLS.pages.bestOf,
  ROUTE_URLS.pages.about,
  ROUTE_URLS.pages.hotel,
]
//const stickHeaderRoutes = [ROUTE_URLS.pages.hotel]
const HOTEL_PAGE: Array<string> = [ROUTE_URLS.pages.hotel]
const NEVER_STICKY_ROUTES: Array<string> = [
...
export function NavBar() {
  ...
  if (noSearchBarRoutes.includes(pathName)) {
    return (
      <>
      ...
      <div>
        ...
        >
          <div className="hidden w-full bg-primary-300 md:block">
            ...
            */}
        {/*} <SearchBarNarrow /> */}
        <div className="w-full bg-primary-300 md:block">
          <div
            className={`${container ? 'container' : 'xl:px-10'} ${
              isHotelPage && 'max-w-hotel-container'
            }  flex-cols mx-auto flex h-searchbar-lg w-full max-w-inner-container items-center bg-primary-300 py-2`}
          >
            <SearchBarDesktop />
          </div>
          <div className="pt-16">
