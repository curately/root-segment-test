...
import { useLocation } from '@/app/layout/searchbar/shared/domain/location-domain'
import { useSearchBarKey } from '@/app/layout/searchbar/shared/domain/use-search-store'
